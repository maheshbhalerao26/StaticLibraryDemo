...
@protocol OMQueueSortDelegate <NSObject>
-(NSComparisonResult)resultForObject1:(id)obj1 object2:(id)obj2;
@end

@interface OMQueue : NSObject<NSCoding, NSFastEnumeration>
...
//sort using delegate method. Delegate should implement OMQueueSortDelegate
-(void)sortUsingDelegate:(id<OMQueueSortDelegate>)delegate;
